...
import bookCharacterTableConstruction
...
def character_analysis(dialog_contexts, dialog_occurrences, chunks, oldAliasTable,oldConnectionsTable,oldAliases, speakers = None, script = False):
    if script:
        aliasTable, connectionsTable, aliases = bookCharacterTableConstruction.build_alias_table_script(chunks, oldAliasTable,oldConnectionsTable,oldAliases, speakers)
    else:
        aliasTable, connectionsTable, aliases = bookCharacterTableConstruction.build_alias_table(chunks, oldAliasTable,oldConnectionsTable,oldAliases)
