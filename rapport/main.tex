...
The second column contains the total number of appearances of names related to the character and the third one contains a 1 if the inferred gender is masculine,
a 0 if it is neutral and a -1 if it is feminine. The last column contains all aliases of the character. }
