...
\subsubsection{Identification of characters in a conversation}
...
The new character extraction process takes proper nouns instead of proper names. It made the process of alias-resolution more complex, which has been solve by an algorithm using semantic information of names and honorifics and inferring gender of characters.
The result have shown that it leads to a decrease of the rate of fake characters around a factor of 2. The alias resolution is also more accurate, different characters are less likely to be merged in a single one.
