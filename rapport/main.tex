...
The development of the software consists of its extension to movie script and the creation of a new algorithm of characters extraction.
This is a multi-pass algorithm extracting all proper proper names and iteratively linking them based on semantic information and inferred genders. 
\end{abstract}
